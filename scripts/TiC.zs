...
mods.tconstruct.Casting.removeTableRecipe(<thermalfoundation:storage:4>);
...
mods.tconstruct.Melting.removeRecipe(<liquid:platinum>,<tconstruct:shard>.withTag({Material: "platinum_plustic"}));
mods.tconstruct.Melting.removeRecipe(<liquid:osmiridium>,<plustic:osmiridiumnugget>);
